...
CXX_BENCHMARK_FLAGS = $(CXXFLAGS) -Wextra -Wshadow -pedantic -O3 -g -fno-omit-frame-pointer
CXX_TEST_FLAGS      = $(CXXFLAGS) -Wextra -Wshadow -pedantic -O3 -g -fno-omit-frame-pointer
CXX_RELEASE_FLAGS   = $(CXXFLAGS) -O3 -march=native -mtune=native
CXX_DEBUG_FLAGS     = $(CXXFLAGS) -Wextra -Wshadow -pedantic -g -O2 -fsanitize=address
