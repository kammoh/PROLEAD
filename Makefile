...
C_RELEASE_FLAGS   = $(CFLAGS) -Wno-unused-parameter -Wno-unused-but-set-variable -O3 -march=native -mtune=native -DNDEBUG
C_DEBUG_FLAGS     = $(CFLAGS) -Wextra -pedantic -g -O2 -fno-omit-frame-pointer -fsanitize=address
C_TEST_FLAGS      = $(CFLAGS) -Wextra -pedantic -O3 -g -fno-omit-frame-pointer -fsanitize=address
